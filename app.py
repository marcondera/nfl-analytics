...
def display_final_results_styled(df_finalized):
    ...
    Layout compacto e sem a barra vazia.
    """
    
    rows = [row for index, row in df_finalized.iterrows()]
    
    # CSS com ajustes para layout mais compacto e remoção do espaço vago
    st.markdown("""
        <style>
            .stApp {
            ...
            .nfl-team-block {
                ...
                margin-bottom: 8px; /* Reduzido o espaço entre os times */
            }
            .nfl-team-info {
                display: flex;
                align-items: center;
                /* Removido flex-grow: 1 para diminuir o espaço vago */
                margin-right: 15px; 
                max-width: 180px; /* Limita a largura do bloco do nome/logo */
            }
            .nfl-score {
