...
# --- 2. FUNÇÕES DE PROCESSAMENTO DE DADOS (Inalteradas) ---
...
def display_final_results_styled(df_finalized):
    ...
    com o novo design de placar e texto maior.
    """
    
    rows = [row for index, row in df_finalized.iterrows()]
    
    # CSS com ajuste para texto maior e espaçamento
    st.markdown("""
        <style>
            .stApp {
            ...
            .nfl-card {
                ...
                padding: 12px 15px; /* Mais padding para melhor visual */
                margin: 5px 0; 
            ...
            .nfl-team-info {
                display: flex;
                align-items: center;
                /* Aumenta a área de informação do time para empurrar o placar para o canto */
                flex-grow: 1; 
                margin-right: 15px; /* Diminui o espaço entre o nome e o placar */
            }
            .nfl-score {
                font-size: 22px; 
                font-weight: 500;
                color: #888888; 
                /* O placar do perdedor é menor */
            }
            /* Destaque CRÍTICO para o Vencedor */
            .nfl-score-winner {
                font-size: 26px; /* Placar do vencedor bem maior */
                font-weight: 900; 
                color: #69be28; 
            }
            /* AUMENTO DO TEXTO DO TIME */
            .nfl-abbr {
                font-size: 17px; /* Texto dos times MUITO maior */
                font-weight: 700;
                color: #FAFAFA;
                margin-left: 10px;
                white-space: nowrap;
    ...
    for i in range(0, len(rows), 3):
        ...
        for j, row in enumerate(chunk):
            with cols[j]:
                ...
                # 2. Time Visitante
                # O vencedor tem o placar maior (nfl-score-winner)
...
def main():
    ...
    st.markdown("""
        <style>
            ...
            h2 {
                text-align: center;
                margin-top: 1.5rem; /* Espaço antes do H2 */
    ...
    # SEPARADOR ENTRE FINALIZADOS E AGENDADOS
    st.markdown("---")
